...
import fil_rouge.PrecedenceConstraintWithGap;

public class PrecedenceConstraintWithGapTest {
	...
	private PrecedenceConstraintWithGap p1;
	private PrecedenceConstraintWithGap p2;
	private PrecedenceConstraintWithGap p3;
	...
	public void init() {
		...
		date2=new MyCalendar(02,27,10,11);
		date3= new MyCalendar(02,27,11,30);
		date4=new MyCalendar(02,27,13,11);
		...
		p1= new PrecedenceConstraintWithGap(activity1,activity2,10);
		p2=new PrecedenceConstraintWithGap(activity3,activity4,10);
		p3= new PrecedenceConstraintWithGap(activity5,activity6,10);
