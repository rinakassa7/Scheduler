...
import fil_rouge.RandomScheduler;
import fil_rouge.Verifier;

public class RandomSchedTest {
	...
	HashMap<Activity,MyCalendar>scheduleAl;
	...
	public void init() {
		...
		scheduleAl=schedule.EmploiAleatoire();
...
public void nombreTest() {
	int nombre=schedule.ConstraintesSatisfaites(EDT);
	Assert.assertTrue("ça doit retourner True ",nombre==2);
		}
}
